...
def mean():
    print("Среднее арифметическое чисел ", a, "и ", b, "равно ", (a + b)/2)
    print("Среднее арифметическое чисел ", a, "и ", c, "равно ", (a + c)/2)
    print("Среднее арифметическое чисел ", a, "и ", d, "равно ", (a + d)/2)
    print("Среднее геометрическое чисел ", a, "и ", b, "равно ", round(a/(a*b), 3))
    print("Среднее геометрическое чисел ", a, "и ", c, "равно ", round(a/(a*c), 3))
    print("Среднее геометрическое чисел ", a, "и ", d, "равно ", round(a/(a*d), 3))
